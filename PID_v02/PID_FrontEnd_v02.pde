...
float InScaleMax = 66;    // and Max for both
float OutScaleMin = 0;      // the top and 
float OutScaleMax = 1250;    // bottom trends
...
void setup()
{
  ...
  String s = Serial.list()[0];
  myPort = new Serial(this, s, 9600);                //   Communication with
