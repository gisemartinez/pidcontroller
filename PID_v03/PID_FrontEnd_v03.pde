 ...
 **********************************************/
int windowWidth = 800;      // set the size of the 
int windowHeight = 600;     // form

float InScaleMin = 0;       // set the Y-Axis Min
float InScaleMax = 25;    // and Max for both
float OutScaleMin = 0;      // the top and 
float OutScaleMax = 25;    // bottom trends
...
void setup()
{
  ...
  //fullScreen();
  println("Serial list");
  printArray(Serial.list());                                           // * Initialize Serial
  ...
  AMButton = controlP5.addButton("Modo")
     //.setValue(0.0)
     .setPosition(10,50)
     .setSize(60,20)
     ;
  ...
  controlP5.addButton("Send_To_Arduino")
     //.setValue(0.0)
     .setPosition(10,475)
     .setSize(120,20)
     ;
